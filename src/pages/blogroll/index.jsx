...
const columns = [
  {
    ...
    dataIndex: 'name',
    key: 'name',
    render: (text, record) => <a href={ record.address } target="_blank" rel="noopener noreferrer">{text}</a>,
  },
  {
    title: '博客地址',
    dataIndex: 'address',
  ...
  },
  {
    ...
    render: (isShow, record) => (
      <Switch checkedChildren="开启" unCheckedChildren="关闭" defaultChecked={ isShow } />
    ),
  },
  {
    title: '操作',
    ...
    return (
      <div className="blog-contain">
        <div className="search">
          <Search placeholder="输入关键字查询" onSearch={value => console.log(value)} enterButton />
        </div>
        <div className="table">
